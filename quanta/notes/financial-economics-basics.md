...
- **Commodities**: basic physical goods that are interchangeable with other goods of the same type; often used as inputs in the production of other goods or services (hard: natural resources that are mined/extracted vs soft: agricultural products or livestack that are grown/raised)
